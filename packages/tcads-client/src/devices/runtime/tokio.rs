...
impl AdsRuntime {
    ...
    ///   `[50i32, 25i32]` or `vec![50i32, 25i32]`).
    ///
    ...
    /// - **Multiple Outputs:** Returns a tuple or sequence.
    ///
    ...
    ///     device.rpc(fb_path, "DivideValues", (100i32, 3i32)).await?;
    /// # Ok(())
    /// # }
    /// ```
    pub async fn rpc<O>(
