...
//!
//! This crate provides a way to communicate with TwinCAT devices (PLCs, NC, etc.), without relying
//! on the official Beckhoff `TcAdsDll.dll` or requiring a local TwinCAT installation on the
//! client machine.
//!
